        ...
        <div className='w-full h-full bg-gradient-to-br from-blue-600 via-blue-700 to-blue-800 flex items-center justify-center'>
                  <div className='text-center text-white p-8 max-w-md'>
                      ...
                      <p className='text-xl opacity-90 mb-4'>
                        Your trusted partner in accessible and quality healthcare services, anytime and anywhere.
                      </p>
                      <p className='text-lg opacity-75'>
                        Connecting you with certified medical professionals for seamless virtual consultations and personalized care.
                      </p>
