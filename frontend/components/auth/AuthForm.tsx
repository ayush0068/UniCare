...
const AuthForm = ({type, userRole} : AuthFormProps) => {
  ...
  const {registerDoctor, registerPatient, loginDoctor, loginPatient, loading, error, isAuthenticated, user} = userAuthStore ();
  ...
  const title = isSignUp ? 'Create an Account with UniCare+' : 'Welcome back to UniCare+';
  ...
  return (
    <div className='w-full max-w-md mx-auto'>
      <div className='text-center mb-8'>
        <h1 className='text-4xl font-bold text-blue-900'>UniCare+</h1>
      </div>
          ...
          {error && (
            ...
            <form onSubmit= {handleSubmit} className='space-y-6'> 
                {isSignUp && (
                  ...
                  {isSignUp && (
                    <div className='flex items-start space-x-2'>
                      ...
                      <label htmlFor='terms' className='text-sm text-gray-600 leading-5'>
                          I Confirm that I have read and agree to the terms and conditions and agree to the privacy policy of UniCare+'s {' '}
                  ...
                  <Button type='submit' className='w-full bg-blue-600 hover:bg-red-700 rounded-full py-3'
