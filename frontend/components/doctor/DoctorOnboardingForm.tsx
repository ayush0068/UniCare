...
import { da, sl } from 'date-fns/locale';
  ...
  const [currentStep, setCurrentStep] = useState<number>(1)
      ...
      const handleCategoryToggle = (category:string): void => {
        setFormData((prev:DoctorFormData)  => ({
          ...prev,
          categories: prev.categories.includes(category) ? prev.categories.filter((c:string) => c!== category) : [...prev.categories, category]
        }));
      };
          ...
          {currentStep === 1 && (
              <div className='space-y-6'>
                  ...
                  <div className='space-y-3'>
                    ...
                    <p className='text-sm text-gray-600'>Select the HealthCare Categories that apply to you (Select at least one)</p>
                  ...
                  <div className='space-y-2'>
                    <Label htmlFor='about'>About Your</Label>
                    <Input 
                      id='about'
                      name='about'
                      type='text'
                      value={formData.about}
                      placeholder='e.g., I am a Cardiologist with 5 years of experience'
                      onChange={handleInputChange}
                      required
                    />
                  </div>
                  ...
                  <div className='space-y-2'>
                    <Label htmlFor='fees'>Consultancy Fee (₹)</Label>
                    <Input 
                      id='fees'
                      name='fees'
                      type='number'
            ...
            {currentStep === 3 && (
              <div className='space-y-6'>
                  ...
                  <div className='space-y-3'>
                        ...
                        <p className='text-sm text-gray-600'>Select the days on which you are NOT available</p>
                                  ...
                                  onCheckedChange={(checked) => {
                                    if(checked) {
                                      ...
                                      setFormData((prev) => ({
                                        ...
                                        availabilityRange: {
                                          ...prev.availabilityRange,
                                          excludedWeekdays: prev.availabilityRange.excludedWeekdays.filter((d) => d !== value)
                                        }
                                      }))
                                    }
                                  }}
