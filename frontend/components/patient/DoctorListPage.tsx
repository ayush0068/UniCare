            ...
            <div className='max-w-7xl mx-auto px-4 py-6'>
                    ...
                    <div className='flex gap-4 mb-6'>
                            <div className='flex-1 relative'>
                                    ...
                                    <Input
                                        placeholder='Search Doctor by name, specialization or condition...'
        ...
        <div className='max-w-7xl mx-auto px-4 py-8'>
            ...
            {loading ? (
                            ...
                            <CardContent className='p-6 flex flex-col h-full'>
                                ...
                                <div className='mt-auto'>
                                    <Link href={`/patient/booking/${doctor._id}`}>
                                        <Button className='w-full bg-blue-600 hover:bg-red-700 text-white rounded-lg py-2 text-sm font-medium shadow-lg hover:shadow-xl transition-all'>
                                            Book Appointment
                                        </Button>
                                    </Link>
                                </div>
                ...
                <Card className='p-12 text-center'>
                    ...
                    <p className='text-gray-500 mb-4'>Try changing or removing some filters</p>
